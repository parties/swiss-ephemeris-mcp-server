...
path in `index.js` or `lib/event-search.js` means running `npm run test:slow` and budgeting hours
for it — say which of the two you ran when you report a result. Details and timings:
`CONTRIBUTING.md`.
