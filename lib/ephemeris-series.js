...
// This module is the only place that asks for `swetest` (via lib/swetest-exec.js) on
// behalf of the event search engine (lib/event-search.js) - the engine itself takes
// providers built from these functions and never spawns anything of its own, which is
// what lets a progressions/solar-arc provider be swapped in later without touching it.
